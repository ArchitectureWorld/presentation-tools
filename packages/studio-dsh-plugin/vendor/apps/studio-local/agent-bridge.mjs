...
export function createAgentBridge({ url = process.env.REPORT_STUDIO_AGENT_URL || '', fetchImpl = fetch, timeoutMs = Number(process.env.REPORT_STUDIO_AGENT_TIMEOUT_MS || 60000) } = {}) {
  ...
  return {
    ...
    submit({ submission, context = null, taskId = null, parentSessionId = null, leaseMs = null }) {
      return call({ kind: 'report_studio.review_submission', executionMode: 'isolated', taskId, parentSessionId, leaseMs, submission, context });
    },
