...
- [ ] 批次 3 — 二进制 ObjectStore 与 Asset Ingestion
...
- [ ] 批次 6 — Draft Edit Buffer 与 no-op
...
- [ ] 批次 7 — ReviewSubmission 与严格 Command
...
- [ ] 批次 10 — 全量门禁、文档和真实宿主
  ...
  - Provider 恢复后完成真实 Proposal 闭环；配置 main required checks；保持 PR Draft，等待人工验收。
